...
const NAV_ITEMS = [
  ...
  { to: "/quotations", label: "عروض الأسعار", icon: "📝", perm: "sales.quotations" },
  ...
  { to: "/analytics", label: "التحليلات", icon: "📈", perm: "reports.view" },
  { to: "/users", label: "المستخدمون", icon: "👥", perm: "users.manage" },
  { to: "/tax-types", label: "أنواع الضريبة", icon: "💰", perm: "accounting.view" },
  { to: "/tax-report", label: "تقرير الضريبة", icon: "🧾", perm: "reports.view" },
  { to: "/income-statement", label: "قائمة الدخل", icon: "📊", perm: "reports.view" },
  { to: "/balance-sheet", label: "الميزانية العمومية", icon: "🏦", perm: "reports.view" },
];
